...
#
# The Cairo GPS collects several programs and creates a proof that they ran
...
#
# 3. Click on "Send to GPS" to send the program to the proving service.
#
# After the proof is created, the GPS sends it to an [Ethereum ropsten contract](https://ropsten.etherscan.io/address/0xf0EC41069A89595ADf5f27A4a90ff2DF30D83d2E).
...
#   ])
#
# You can also find your job's fact in the GPS tracking page you opened
# in step 4.
#
